...
int main() {
	...
	Time T3_diff = T3.timeUntil(Time(12, 0, 0));
	cout << "Time until 12:00:00 for T3: " << T3_diff.getHours() << " hours, " << T3_diff.getMinutes() << " minutes, " << T3_diff.getSeconds() << " seconds" << endl;
